                        ...
                        <div class="col-md-7">
                           ...
                           <div class="logo wow fadeInDown"> <a href=""><img src="images/logo.png" alt="logo"></a></div>
                            ...
                            <h1 class="wow fadeInLeft">
                                Get all the short codes and Ussds you need in Nigeria.
                            </h1>

                            <!-- /.header paragraph -->
                            <div class="landing-text wow fadeInUp">
                                <p>Short Code is a directory of various shortcodes and Unstructured Supplementary Service Data(USSD) in Nigeria. The codes are used for
				<ul style="color:white; "list-style-type:circle;">
			        <li> Payment services </li>
				<li> Airtime Recharges </li>
				<li> SMS voting </li>
                                <li> Other Financial services and many more, all on your mobile phone.</li>
			    </ul>		
                            </div>				  
                        ...
                        <div class="col-md-5">
                            <div class="signup-header wow fadeInUp">
                                <h3 class="form-title text-center">GET TO KNOW WHEN WE LAUNCH.</h3>
                ...
                <div class="col-sm-4 col-sm-offset-4">
                    ...
                    <div class="social text-center">    		
                        <ul>
                            ...
                            <li><a class="wow fadeInUp" href="https://instagram.com/" data-wow-delay="0.4s"><i class="fa fa-instagram"></i></a></li>
                        </ul>
                    </div>	
                    <div class="text-center wow fadeInUp" style="font-size: 14px;">Copyright Short Code 2019 - Powered by  <a href="https://www.advent-tech.com/" target="_blank">Advent-Tech</a></div>
